$(function() {
	...
	$("body").on("click", ".prjDetails", function() {
		...
		console.log(id)
		layershow("项目详情", webPath + "nyd/prj/gotoChange/form?prjId=" + id, "100%", '100%');
    })
...
//			console.log(row.status.yonSubmit);
	...
	},
	{
		...
		title: "操作",
		formatter : function(value, row, index) {
			return "<a class='prjDetails' data-id='" + row.id + "' data-processinstanceid='" + row.processInstanceId + "' href='javascript:;'>编辑</a>"
		},
		align:"center"
	}
	];
