...
<%-- 								data-option="{url:'${ctx}/sys/dict/list/all',textField:'name',valueField:'id',parameter:{typeCode:'app-type'}}"> --%>
<!-- 						</div> -->
<!-- 						<div class="col-sm-3"> -->
...
<!-- 						</div> -->
	...
	<!--自定义js -->
	<script type="text/javascript" src="${ctx}/views/workflow/process/js/running.js"></script>
