...
<body class="gray-bg">
		...
		<div id="divmap">
			<div class="divChange" style="height: 100%">
				...
				<div style="padding-bottom: 20px;">
					<a href="javascript:;" id="locationLayer" class="btn btn-primary jzdForm"><i style="font-size: 14px"
						class="glyphicon glyphicon-plus"></i>加载界址点</a>
			...
			<div class="divChange" style="display: none; clear: both;">
				<form id="tableFather" class="form-horizontal">
					<input id='prjId' value='${prjInfo.id }' type="hidden" name="id">
					...
					<table id="prjTable" class="table">
						...
						<tr>
							...
							<td><div class="form-group">
									<input type="text"  class="shengchanCash form-control" name="prodFarmland" value="${prjInfo.prodFarmland }">
								</div></td>
							<td><div class="form-group">
						...
						<tr>
							...
							<td rowspan="3">
								...
								<div class="form-group">
									<input class="customYON" value="${prjInfo.attachYonDoc }" id="" name="attachYonDoc"
	...
	<script type="text/javascript" src="${ctx}/views/nyd/prj/js/form.js"></script>
