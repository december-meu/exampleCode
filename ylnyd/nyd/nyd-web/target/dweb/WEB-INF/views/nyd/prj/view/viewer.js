...
if (typeof window !== 'undefined' && window['pdfjs-dist/build/pdf']) {
  ...
  pdfjsLib = require(webBasePath+'/views/nyd/prj/pdfjs/build/pdf.js');
}
...
function configure(PDFJS) {
  PDFJS.imageResourcesPath = webBasePath+'/views/nyd/prj/pdfjs/web/images/';
  PDFJS.workerSrc = webBasePath+'/views/nyd/prj/pdfjs/build/pdf.worker.js';
  PDFJS.cMapUrl = webBasePath+'/views/nyd/prj/pdfjs/web/cmaps/';
...
var DEFAULT_URL = baseurl+pdfurl;
;
...
function getViewerConfiguration() {
  return {
    ...
    debuggerScriptPath: webBasePath+'/views/nyd/prj/pdfjs/web/debugger.js',
