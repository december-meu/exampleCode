...
<link rel="stylesheet" href="${ctxStatic}/Hplus/js/plugins/laydate/theme/default/laydate.css">
...
<link href="${ctxStatic}/plugins/ztree/css/zTreeStyle.css" rel="stylesheet">
<link href="${ctxStatic}/common/css/customer.css" rel="stylesheet">
<link rel="icon" href="${ctxStatic}/images/logo.ico" type="image/x-icon"/>
...
<script src="${ctxStatic}/plugins/ztree/js/jquery.ztree.all.min.js"></script>
