...
<body class="gray-bg">
<c:if test="${flag=='start'}">
	<body class="gray-bg wrapper wrapper-content container" style="margin: 0;">
		<div class="row" style="clear: both;">
			<h2 style="width: 200px; margin: 0 auto; text-align: center;"></h2>
		</div>
</c:if>
...
<input type="hidden" id="createUserId" value="${!empty leave?leave.createUserId:''}">
<input type="hidden" id="flag" value="${flag}">

	<div class="wrapper wrapper-content" style="height: 100%">
 	<c:if test="${flag=='start'}">
		<button type="button" class="btn btn-primary submit" id = "btnStartProcess">提交</button>
	</c:if> 
	...
	<div id="divmap">
		<div class="divChange" style="height: 100%">
			...
			<div id="mapContent" style="height: calc(100% - 50px)">
				...
				<div id="mapMain">
					<div id="map">
						<div class="layui-btn-group">
							<button class="layui-btn" id="mt_goback">重置</button>
							<button class="layui-btn" id="mt_zoomin">放大</button>
							<button class="layui-btn" id="mt_zoomout">缩小</button>
							<button class="layui-btn" id="mt_length">距离</button>
							<button class="layui-btn" id="mt_area">面积</button>
							<button class="layui-btn" id="mt_clear">删除</button>
							<button class="layui-btn" id="mt_query">属性</button>
							<button class="layui-btn" id="mt_locate">定位</button>
						</div>
					</div>
				</div>
			</div>
...
<script type="text/javascript" src="${ctx}/views/nyd/prj/approval/js/task.js"></script>
